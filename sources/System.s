...
;             R             B                    G
    .db     ((0x00 >> 1) | (0x00 >> 5)) & 0x77, (0x00 >> 5) & 0x07
    .db     ((0x00 >> 1) | (0x00 >> 5)) & 0x77, (0x00 >> 5) & 0x07
    .db     ((0x3e >> 1) | (0x49 >> 5)) & 0x77, (0xb8 >> 5) & 0x07
    .db     ((0x74 >> 1) | (0x7d >> 5)) & 0x77, (0xd0 >> 5) & 0x07
    .db     ((0x59 >> 1) | (0xe0 >> 5)) & 0x77, (0x55 >> 5) & 0x07
    .db     ((0x80 >> 1) | (0xf1 >> 5)) & 0x77, (0x76 >> 5) & 0x07
    .db     ((0xb9 >> 1) | (0x51 >> 5)) & 0x77, (0x5e >> 5) & 0x07
    .db     ((0x65 >> 1) | (0xef >> 5)) & 0x77, (0xdb >> 5) & 0x07
    .db     ((0xdb >> 1) | (0x59 >> 5)) & 0x77, (0x65 >> 5) & 0x07
    .db     ((0xff >> 1) | (0x7d >> 5)) & 0x77, (0x89 >> 5) & 0x07
    .db     ((0xcc >> 1) | (0x5e >> 5)) & 0x77, (0xc3 >> 5) & 0x07
    .db     ((0xde >> 1) | (0x87 >> 5)) & 0x77, (0xd0 >> 5) & 0x07
    .db     ((0x3a >> 1) | (0x41 >> 5)) & 0x77, (0xa2 >> 5) & 0x07
    .db     ((0xb7 >> 1) | (0xb5 >> 5)) & 0x77, (0x66 >> 5) & 0x07
    .db     ((0xcc >> 1) | (0xcc >> 5)) & 0x77, (0xcc >> 5) & 0x07
    .db     ((0xff >> 1) | (0xff >> 5)) & 0x77, (0xff >> 5) & 0x07
